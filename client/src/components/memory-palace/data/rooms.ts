...
export const rooms: Room[] = [
  ...
  },
  {
    ...
    zones: [
      { id: 'ticket-office', name: 'Ticket Office', nameIt: 'La Biglietteria', description: 'Buying tickets', icon: '🎫', categories: ['transport'], x: 20, y: 45, width: 22, height: 25, interiorImage: '/palace/rooms/transport-ticket.jpg', interiorVocab: [{ word: 'biglietto', x: 30, y: 40 }, { word: 'andare', x: 55, y: 35 }, { word: 'prendere', x: 45, y: 55 }, { word: 'dove', x: 70, y: 45 }] },
      { id: 'platform', name: 'Platform', nameIt: 'Il Binario', description: 'Trains and departure', icon: '🚂', categories: ['transport'], x: 50, y: 40, width: 25, height: 30, interiorImage: '/palace/rooms/transport-platform.jpg', interiorVocab: [{ word: 'treno', x: 35, y: 35 }, { word: 'arrivare', x: 60, y: 30 }, { word: 'partire', x: 45, y: 50 }, { word: 'binario', x: 75, y: 40 }] },
      { id: 'street', name: 'Street Exit', nameIt: 'L\'Uscita', description: 'Directions and navigation', icon: '🚶', categories: ['buildings'], x: 80, y: 50, width: 18, height: 25, interiorImage: '/palace/rooms/transport-street.jpg', interiorVocab: [{ word: 'sinistra', x: 25, y: 40 }, { word: 'destra', x: 55, y: 35 }, { word: 'vicino', x: 40, y: 55 }, { word: 'lontano', x: 70, y: 50 }] },
    ],
  },
  {
    id: 'living-room',
